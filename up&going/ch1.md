...
<img src="http://static.uv-w.com/You-Dont-Know-JS/up&going/fig1.png" width="500">
...
<img src="http://static.uv-w.com/You-Dont-Know-JS/up&going/fig2.png" width="500">

一旦你点击“OK”提交输入的文本，你将会看到你输入的值被存储在变量`age`中，然后我们使用`console.log(..)`把它 *输出*：

<img src="http://static.uv-w.com/You-Dont-Know-JS/up&going/fig3.png" width="500">
